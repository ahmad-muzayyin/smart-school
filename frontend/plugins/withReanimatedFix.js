...
module.exports = function withReanimatedFix(config) {
    return withDangerousMod(config, [
        ...
        async (config) => {
            ...
            // Fix 3: BorderRadiiDrawableUtils.java - Delete the file (use fallback)
            ...
            if (fs.existsSync(borderPath)) {
                // Delete the problematic file - Reanimated will use the fallback version
                fs.unlinkSync(borderPath);
                console.log('✅ Removed BorderRadiiDrawableUtils.java (using fallback)');
            }
