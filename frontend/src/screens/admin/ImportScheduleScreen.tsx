        ...
        try {
            ...
            const downloadTemplate = async () => {
                try {
                    ...
                    // Note: client.get with blob in RN might return base64 string or binary string depending on adapter.
                    // Safer to use FileSystem.downloadAsync, but we need headers.
                    // Let's rely on Sharing for now if file logic is complex, or just show alert.
